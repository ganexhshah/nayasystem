...
import { RefreshCw, Search, Clock, ChevronRight, Users } from "lucide-react"
...
export default function PosWaiterOrdersPage() {
  ...
  const filtered = orders
    .filter(o => {
      if (tab === "active")  return !["completed", "cancelled"].includes(o.status) && o.payment_status !== "paid"
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-card shrink-0">
        ...
        <span className="text-sm font-semibold flex-1">Waiter Orders</span>
